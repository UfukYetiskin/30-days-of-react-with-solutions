        ...
        return(
            <div  style={this.state.color}>
                ...
                <div>
                    ...
                    <div>
                        <img src={this.state.countries.flag} alt="AnimalImage"/>
                        <div><span><strong>Country Name: {this.state.countries.name} </strong></span></div>
                        <div><span><strong>Capital: {this.state.countries.capital} </strong></span></div>
                        <div><span><strong>languages: {this.state.countries.languages} </strong></span></div>
                        <div><span><strong>Population:  {this.state.countries.population} </strong></span></div>
                        <div><span><strong>Currency: {this.state.countries.currency} </strong></span></div>
                        <button onClick={this.getNewCountry}>Random Country</button>
                    </div>
                </div>
